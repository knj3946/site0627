...
//특히 복잡한 부분을 추상화 시켜놓아 개발자가 메서드 호출만으로도
//기술구현이 가능하도록 해놓음..


//자바네트워크에서의 소켓은 2종류
//1) 전화를 받는 용도의 소켓:서버소켓이라 함
//2) 대화용 소켓:종이컵과 같음
package net;
...
public class EchoServer {
	ServerSocket server;
	int port=7777; //0~1023까지는 시스템 점유 포트이므로 사용하지 말자
	...
	public EchoServer() {
		try {
			...
			//문자를 모은, 문자열로 업그레이드 하려변 버퍼스트림이 필요함
